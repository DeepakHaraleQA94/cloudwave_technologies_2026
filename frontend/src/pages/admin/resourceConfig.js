...
export const RESOURCES = {
  ...
  learning_resources: {
    title: "Learning Studio", singular: "Resource", titleField: "title",
    columns: [["title", "Title"], ["resource_type", "Type"], ["course_id", "Course ID"], ["module", "Module"], ["active", "Active"]],
    fields: [
      { name: "title", label: "Title", type: "text", full: true },
      { name: "resource_type", label: "Resource Type", type: "select", options: ["Video", "Audio", "Audio Overview", "Video Overview", "Notes", "PDF", "Slide Deck", "Mind Map", "Reports", "Flashcards", "Quiz", "Infographic", "Data Table", "Document", "External Resource"] },
      { name: "course_id", label: "Course ID (copy from Courses)", type: "text" },
      { name: "batch_id", label: "Batch ID (optional)", type: "text" },
    ...
    defaults: { resource_type: "Video", active: true, download_allowed: false, sort_order: 0 },
  },
  slides: {
