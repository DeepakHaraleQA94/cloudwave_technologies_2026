...
export default function ThemeBanner() {
  ...
  return (
    <div data-testid="theme-banner"
      ...
      {preview && <span className="rounded-full bg-white/25 px-2 py-0.5 text-xs font-bold uppercase tracking-wider">Preview</span>}
